<template>
  <el-dialog title="广告位预订" :visible.sync="visible" center>
    <el-form ref="form" :model="formData" :rules="rules" label-width="80px" label-position="top" class="submit-form">
      ...
      <el-row :gutter="20">
        <el-col :sm="12">
          <el-form-item label="广告位类型" prop="signType">
        ...
        <el-col :sm="12">
          <el-form-item label="广告位尺寸" prop="signSize">
            <el-input v-model="formData.signSize" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col :sm="12">
          <el-form-item label="广告位位置" prop="signPosition">
            <el-input v-model="formData.signPosition" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col :sm="12">
          <el-form-item label="广告位价格" prop="signPrice">
            <el-input v-model="formData.signPrice" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col :sm="12">
          <el-form-item label="广告位状态" prop="signStatus">
        ...
        <el-col :sm="12">
          <el-form-item label="广告位备注" prop="signRemark">
            <el-input v-model="formData.signRemark" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col :sm="12">
          <el-form-item label="广告位图片" prop="signImg">
            <el-upload
              class="upload-demo"
        ...
        <el-col :sm="12">
          <el-form-item label="广告位视频" prop="signVideo">
            <el-upload
              class="upload-demo"
              action="https://jsonplaceholder.typicode.com/posts/"
              :on-preview="handlePreview"
      ...
      <el-row :gutter="20">
        ...
        <el-col :sm="24">
          <el-form-item label="会议名称" prop="contactEmail">
            <el-input v-model="formData.contactEmail" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col :sm="24">
          <el-form-item label="会议时间" prop="contactEmail">
            <el-date-picker
              v-model="form.date"
              type="datetimerange"
              range-separator="至"
        ...
        <el-col :sm="24">
          <el-form-item label="参会人员" prop="contactEmail">
            <el-input v-model="formData.contactEmail" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col :sm="24">
          <el-form-item label="会议内容" prop="contactEmail">
            <el-input v-model="formData.contactEmail" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col :sm="24">
          <el-form-item label="备注" prop="contactEmail">
            <el-input v-model="formData.contactEmail" placeholder="请输入" />
          </el-form-item>
        </el-col>
      </el-row>
